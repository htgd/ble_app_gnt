...
static i2c_write_callback_t   m_i2c_write_callback = 0;
static i2c_read_callback_t    m_i2c_read_callback = 0;


/**
* lis3dh注册通信接口操作函数
* @param[in] i2c_write_callback		i2c写操作
* @param[in] i2c_read_callback    	i2c读操作
* @return 	none
*/
void lis3dh_regist_init(i2c_write_callback_t i2c_write_callback, i2c_read_callback_t i2c_read_callback)
{
    m_i2c_write_callback = i2c_write_callback;
    m_i2c_read_callback = i2c_read_callback;
}
...
//    IIC_ReadByte(0x19, Reg, Data);
    
    return (m_i2c_read_callback(Reg, Data, 1));
}
...
//    IIC_WriteByte(0x19, WriteAddr, Data);
    
    return(m_i2c_write_callback(WriteAddr, &Data, 1));
}
...
{
    if( !LIS3DH_ReadReg(LIS3DH_REFERENCE_REG, val) )
    return MEMS_ERROR;
...
/*******************************************************************************
* Function Name  : LIS3DH_Int2LatchEnable
