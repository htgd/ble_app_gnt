...
#define DEVICE_SW_REVISION          "S01010041907031"
#define DEVICE_HW_REVISION          "HGTNBGNT0103002"
...
//  <h> 蓝牙通信配置
//  <e> 蓝牙静态配对密码使能 - GNT_BLE_SEC_MITM_EN
//  <i> 连接需要密码配对， 0，BLE无安全
#define GNT_BLE_SEC_MITM_EN     0
//  <s0.6> 静态配对密码 - BLE_STATIC_PASSKEY
#define BLE_STATIC_PASSKEY      "654321"
//  </e>
//  </h>
//=====End of 蓝牙通信配置
...
//      <q> 门锁模拟模式 - IODM_CMD_TEST_EN
//      <i> 1：使能改模式， 0：不使能
//      <i> 不用时删除对应部分代码
#define IODM_CMD_TEST_EN  0
...
#define GNT_ENABLE_BATTERY_THRESHOLD            ( 10 ) 

// <o> GNT_REPORT_DISABLE_BATTERY_THRESHOLD <1-50>
// <i> 关闭NB上报电池电量阈值
#define GNT_REPORT_DISABLE_BATTERY_THRESHOLD    ( 5 ) 
...
// <i> 关闭GPS定位电池电量阈值
#define GNT_GPS_DISABLE_BATTERY_THRESHOLD       ( 10 ) 

// <o> GNT_GPS_RESUME_BATTERY_THRESHOLD <1-50>
// <i> 恢复GPS定位电池电量阈值
// <i> 当GPS定位因电量低关闭后，电量需恢复一定值才恢复GPS定位功能
#define GNT_GPS_RESUME_BATTERY_THRESHOLD        ( 15 ) 
